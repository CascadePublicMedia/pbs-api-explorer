 ...
 */
final class Version20190418194552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, asset_id, image, profile, updated FROM image');
        ...
        $this->addSql('INSERT INTO image (id, asset_id, image, profile, updated) SELECT id, asset_id, image, profile, updated FROM __temp__image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , updated DATETIME DEFAULT NULL, episode_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
        )');
        $this->addSql('INSERT INTO image (id, asset_id, image, profile, updated) SELECT id, asset_id, image, profile, updated FROM __temp__image');
        $this->addSql('DROP TABLE __temp__image');
        $this->addSql('CREATE INDEX IDX_C53D045F5DA1941 ON image (asset_id)');
