 ...
 */
final class Version20190516205401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, birth_date DATE DEFAULT NULL, retrieval_status CLOB DEFAULT NULL --(DC2Type:array)
        , email VARCHAR(255) NOT NULL, login_provider VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
