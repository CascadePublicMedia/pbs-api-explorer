 ...
 */
final class Version20190419194543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE remote_asset (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, franchise_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , show_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , title VARCHAR(255) NOT NULL, description_short VARCHAR(90) DEFAULT NULL, description_long CLOB DEFAULT NULL, url VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE remote_asset_asset_tag (remote_asset_id INTEGER NOT NULL, asset_tag_id VARCHAR(255) NOT NULL, PRIMARY KEY(remote_asset_id, asset_tag_id))');
        ...
        , remote_asset_id INTEGER NOT NULL, PRIMARY KEY(asset_id, remote_asset_id))');
        ...
        $this->addSql('INSERT INTO asset (id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, content_rating_descriptor, can_embed_player, language, funder_message, updated, player_code, has_captions, chapters) SELECT id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, content_rating_descriptor, can_embed_player, language, funder_message, updated, player_code, has_captions, chapters FROM __temp__asset');
