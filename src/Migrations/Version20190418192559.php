 ...
 */
final class Version20190418192559 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C53D045F362B62A0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, episode_id, image, profile, updated FROM image');
        ...
        , asset_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , image VARCHAR(255) NOT NULL COLLATE BINARY, profile VARCHAR(255) NOT NULL COLLATE BINARY, updated DATETIME DEFAULT NULL, CONSTRAINT FK_C53D045F362B62A0 FOREIGN KEY (episode_id) REFERENCES episode (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C53D045F5DA1941 FOREIGN KEY (asset_id) REFERENCES asset (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO image (id, episode_id, image, profile, updated) SELECT id, episode_id, image, profile, updated FROM __temp__image');
        ...
        $this->addSql('INSERT INTO asset (id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, can_embed_player, language, funder_message, player_code, has_captions, content_rating_descriptor, tags, updated, chapters) SELECT id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, can_embed_player, language, funder_message, player_code, has_captions, content_rating_descriptor, tags, updated, chapters FROM __temp__asset');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO asset (id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, content_rating_descriptor, can_embed_player, tags, language, funder_message, updated, player_code, has_captions, chapters) SELECT id, episode_id, season_id, show_id, franchise_id, title, title_sortable, slug, description_short, description_long, type, premiered, encored, duration, legacy_tp_media_id, dfp_exclude, content_rating, content_rating_descriptor, can_embed_player, tags, language, funder_message, updated, player_code, has_captions, chapters FROM __temp__asset');
        $this->addSql('DROP TABLE __temp__asset');
        $this->addSql('CREATE INDEX IDX_2AF5A5C362B62A0 ON asset (episode_id)');
        $this->addSql('CREATE INDEX IDX_2AF5A5C4EC001D1 ON asset (season_id)');
        $this->addSql('CREATE INDEX IDX_2AF5A5CD0C1FC64 ON asset (show_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, episode_id, image, profile, updated FROM image');
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image VARCHAR(255) NOT NULL, profile VARCHAR(255) NOT NULL, episode_id CHAR(36) DEFAULT \'NULL --(DC2Type:guid)\' COLLATE BINARY --(DC2Type:guid)
