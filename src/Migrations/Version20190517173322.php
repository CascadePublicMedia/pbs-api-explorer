 ...
 */
final class Version20190517173322 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pbs_profile AS SELECT id, first_name, last_name, birth_date, email, login_provider FROM pbs_profile');
        $this->addSql('DROP TABLE pbs_profile');
        $this->addSql('CREATE TABLE pbs_profile (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , first_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, last_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, birth_date DATE DEFAULT NULL, login_provider VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO pbs_profile (id, first_name, last_name, birth_date, email, login_provider) SELECT id, first_name, last_name, birth_date, email, login_provider FROM __temp__pbs_profile');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, birth_date DATE DEFAULT NULL, login_provider VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY, retrieval_status CLOB DEFAULT \'NULL --(DC2Type:array)\' COLLATE BINARY --(DC2Type:array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO pbs_profile (id, first_name, last_name, birth_date, email, login_provider) SELECT id, first_name, last_name, birth_date, email, login_provider FROM __temp__pbs_profile');
        $this->addSql('DROP TABLE __temp__pbs_profile');
        $this->addSql('DROP INDEX IDX_FD25C980523CAB89');
