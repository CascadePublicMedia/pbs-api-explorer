 ...
 */
final class Version20190418195431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , language VARCHAR(2) DEFAULT NULL, funder_message CLOB DEFAULT NULL, updated DATETIME DEFAULT NULL, player_code CLOB DEFAULT NULL, has_captions BOOLEAN DEFAULT NULL, chapters CLOB DEFAULT NULL --(DC2Type:array)
        , PRIMARY KEY(id))');
