 ...
 */
final class Version20190417225152 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , can_embed_player BOOLEAN DEFAULT NULL, tags CLOB DEFAULT NULL --(DC2Type:array)
        , language VARCHAR(2) DEFAULT NULL, funder_message CLOB DEFAULT NULL, images CLOB DEFAULT NULL --(DC2Type:array)
        , updated DATETIME DEFAULT NULL, player_code CLOB DEFAULT NULL, has_captions BOOLEAN DEFAULT NULL, chapters CLOB DEFAULT NULL --(DC2Type:array)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__episode AS SELECT id, season_id, show_id, ordinal, segment, title, title_sortable, slug, tms_id, description_short, description_long, premiered, encored, nola, language, updated FROM episode');
        ...
        $this->addSql('INSERT INTO episode (id, season_id, show_id, ordinal, segment, title, title_sortable, slug, tms_id, description_short, description_long, premiered, encored, nola, language, updated) SELECT id, season_id, show_id, ordinal, segment, title, title_sortable, slug, tms_id, description_short, description_long, premiered, encored, nola, language, updated FROM __temp__episode');
